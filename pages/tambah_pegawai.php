				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab_1">
						<div class="form-group">
							...
							<input required class="form-control" type="text" name="tag" placeholder="Masukan tag">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<!-- <input required class="form-control" type="text" name="jenis_kelamin" placeholder="Masukan jenis_kelamin"> -->
						...
						<div class="form-group">
							...
							<!-- <input required class="form-control" type="text" name="agama" placeholder="Masukan agama"> -->
							<select name="agama" class="form-control input-medium">
								<option value=""></option>
								<?php
								foreach ($agama as $data_agama) { ?>
									<option value="<?php echo $data_agama['kode_agama']; ?>"> <?php echo $data_agama['nama_agama']; ?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
							...
							<select name="status_kawin" class="form-control input-medium">
								...
								foreach ($status as $data_status) { ?>
									<option value="<?php echo $data_status['kode_nikah']; ?>"> <?php echo $data_status['keterangan']; ?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
							...
							<select name="divisi" class="form-control input-medium">
								...
								foreach ($divisi as $data_divisi) { ?>
									<option value="<?php echo $data_divisi['kode_divisi']; ?>"> <?php echo $data_divisi['nama_divisi']; ?></option>
								<?php } ?>
							</select> </div>
					</div>
						...
						<div class="form-group">
							...
							<select name="jabatan" class="form-control input-medium">
								...
								foreach ($jabatan as $data_jabatan) { ?>
									<option value="<?php echo $data_jabatan['kode_jabatan']; ?>"> <?php echo $data_jabatan['nama_jabatan']; ?></option>
								<?php } ?>
							</select>
						</div>
					</div>
					...
					<div class="tab-pane" id="tab_5">
						<div class="form-group">
							...
							<select name="kategori_karyawan" class="form-control input-medium">
								...
								foreach ($kategori as $data_kategori) { ?>
									<option value="<?php echo $data_kategori['kode_katkaryawan']; ?>"> <?php echo $data_kategori['nama_katkaryawan']; ?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
						...
						<!-- <div class="form-group">
							...
							<input required class="form-control" type="text" name="norek" placeholder="Masukan norek">
						</div> -->
					</div>

				</div>
				<button type="submit" name="submit_pegawai" class="btn btn-outline-primary mt-3 float-right" value="simpan">Tambahkan</button>
